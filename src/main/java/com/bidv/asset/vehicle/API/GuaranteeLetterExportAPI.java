...
//    @PostMapping("/preview")
//    public ResponseEntity<byte[]> preview(@RequestBody GuaranteeLetterDTO dto,String template) throws Exception {
//
//        byte[] word = guaranteeLetterExportService.generateDeXuatBaoLanh(dto,template);
//
...
//    }
    ...
    public ResponseEntity<byte[]> exportThuBaoLanh(@RequestBody GuaranteeLetterDTO dto,@RequestParam("template") String template) throws Exception {
    ...
    public ResponseEntity<byte[]> exportPhanYKien(@RequestBody GuaranteeLetterDTO dto,@RequestParam("template") String template) throws Exception {
