...
public class GuaranteeLetterExportAPI {
    ...
    public ResponseEntity<byte[]> preview(@RequestBody GuaranteeLetterDTO dto,String template) throws Exception {
        ...
        byte[] word = guaranteeLetterExportService.generateWord(dto,template);
    ...
    @PostMapping("/export")
    public ResponseEntity<byte[]> export(@RequestBody GuaranteeLetterDTO dto,@RequestParam("template") String template) throws Exception {
