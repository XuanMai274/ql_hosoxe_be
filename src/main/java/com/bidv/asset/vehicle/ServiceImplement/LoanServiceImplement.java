...
public class LoanServiceImplement implements LoanService {
        ...
        @Autowired
        GuaranteeLetterRepository guaranteeRepository;
        @Autowired
        ...
        public LoanDTO createLoan(
                ...
                DisbursementEntity disbursementEntity = disbursementRepository
                                .findById(dto.getDisbursementDTO().getId())
                                .orElseThrow(() -> new RuntimeException("disbursementEntity not found"));
        ...
        @Override
        public Page<LoanDTO> getLoansByCustomerId(Long customerId, int page, int size) {
                Pageable pageable = PageRequest.of(page, size, Sort.by("createdAt").descending());
